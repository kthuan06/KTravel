...
if(isset($_GET['action']) && $_GET['action'] =='booknow' && isset($_SESSION['id_user'])){
...
<section class="mx-20 mt-10">
   ...
   <p class="font-bold mt-5">BẠN CẦN ĐĂNG NHẬP ĐỂ TIẾP TỤC</p><br>
   <a href="http://localhost/DACS2/main/login.php">
        <button class="hidden lg:inline-block py-2 px-6 bg-blue-500 hover:bg-blue-600 text-sm text-white font-bold rounded-xl transition duration-200" >Đăng nhập để đặt hàng</button>
    </a></div>
    <?php
}
?>